...
export default function PaginaInicial() {
  const [username, setUsername] = React.useState('gabs-m');
    ...
    <>
      <Box
        styleSheet={{
          ...
          backgroundImage: 'url(https://i0.wp.com/abglt.org.br/wp-content/uploads/2020/10/wallpaper-pc1-scaled-1.jpg?fit=2560%2C1440&ssl=1)',
